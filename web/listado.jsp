        ...
        <%
            try {
                ...
                if (session.getAttribute("usuarioRegistrado") == null) {
                    ...
                    session.setAttribute("error", "Debe iniciar sesión para acceder al listado");
                ...
                <table class="table table-striped table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-1"><a href="eliminar.jsp?id=<%=listadoCampeones.getString("CodCamp")%>" class=" bi-trash3-fill rowWithImage text-danger" onclick="alert('Has eliminado a <%= listadoCampeones.getString("NomCamp")%> con éxito.')"></a></td>
                        </tr>
                        <%
                                }
                            } catch (Exception e) {
